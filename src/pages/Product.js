      ...
      <div className="flex flex-col" data-dev-hint="wrapper">
            ...
            <div id="slider-1" className="container mx-auto">
              <div className="bg-cover bg-center flex flex-row h-auto text-gray-700 py-8 px-10 object-fill">
                ...
                <div className="md:full rounded-lg">
                  <img className="rounded-xl" src="/image/event.png" alt="" />
                </div>
              </div>
              <br />
            </div>
        ...
        <div className="h-28">
          <form className="flex items-center w-11/12 mb-auto mx-auto">
            ...
            <div className="w-full">
              <div className="relative">
                <div className="icon absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none" style={{ top: '21px' }}>
                  <svg aria-hidden="true" class="w-5 h-5 dark:text-gray-400" style={{ color: 'rgb(125, 87, 61)', opacity: '0.7' }} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className="Button p-2.5 w-52 ml-4 text-sm font-medium drop-shadow-lg">Search</button>
          </form>
        </div>
        <div className="h-28">
              ...
              <ul className="flex items-center ml-4 mt-4 mb-4">
                <li className="mr-4">
                  <div className="rounded-md py-1 px-2 w-fit text-center" style={{ backgroundColor: '#E7E5E5', minWidth: '100px' }}>
                    <p className="font-medium text-gray-600">Game</p>
                  </div>
                </li>
                <li className="mr-4">
                  <div className="rounded-md py-1 px-2 w-fit text-center" style={{ backgroundColor: '#E7E5E5', minWidth: '100px' }}>
                    <p className="font-medium text-gray-600">Web</p>
                  </div>
                </li>
                <li className="mr-4">
                  <div className="rounded-md py-1 px-2 w-fit text-center" style={{ backgroundColor: '#E7E5E5', minWidth: '100px' }}>
                ...
                <li>
                  <div className="rounded-md py-1 px-2 w-fit text-center" style={{ backgroundColor: '#E7E5E5', minWidth: '100px' }}>
                    <p className="font-medium text-gray-600">UI/UX</p>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <div className="h-auto">
          <div class="grid grid-cols-3 place-items-center gap-6 mt-4">
            {product.map((event) => {
              return <ProductCard eventCategory={event.category} eventTitle={event.title} eventBy={event.by} eventDesc={event.desc} />;
            })}
          </div>
        </div>
        <div className="h-72">
          <div className={`grid grid-rows-4 grid-cols-4  gap-8 justify-items-center`}></div>
          <div className="flex justify-center gap-5">
            ...
            <ul className="flex items-center gap-2">
              <li className={`h-12 w-12 rounded-xl border-4 border-white text-white  flex items-center justify-center bg-orangeAccent-500 hover:bg-orangeAccent-400`}>
                <button className="h-full w-full">1</button>
              </li>
              <li className={`h-12 w-12 rounded-xl border-4 border-white text-white  flex items-center justify-center bg-orangeAccent-300 hover:bg-orangeAccent-400`}>
