...
const ResearchPage = () => {
  ...
  return (
    <div className="">
      <Header type="title" title="ASE Research" />
                ...
                <div id="slider-1" className="container mx-auto">
                  <div className="bg-cover bg-center flex flex-row h-auto text-gray-700 py-8 px-10 object-fill">
                    <div style={{ width: "40%", marginTop: "8%" }}>
                      <h1 className="text-4xl font-medium mb-4 text-textColor">
                        Blogs, article and publications to read
                      </h1>
                      <p className="text-lg mb-9 text-textColor">
                        Find articles and publications to help research and
                    ...
                    <div className="md:full rounded-lg">
                      <img
                        ...
                        src={process.env.PUBLIC_URL + "/image/research.png"}
                        alt=""
                      />
                    </div>
                  </div>
            ...
            <div className="h-28">
              <div className="h-auto flex items-center ml-12 mr-14">
                <div className="container mx-auto ">
                  <p className="text-3xl ml-4">Blog and article</p>
