function MemberCard({division,name,gen}) {
    ...
    return ( 
        <div className="rounded-md bg-white w-72" >
            <img className="rounded-t-md max-h-52 w-full object-cover " src="https://images.unsplash.com/photo-1579567761406-4684ee0c75b6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" alt="tech" />
            <div className="card-container p-4 flex flex-col gap-4 pb-9">
                <div className="rounded-md py-1 px-2 w-fit text-center" style={{backgroundColor : "#E7E5E5", minWidth : "100px"}}>
                    <p className="font-medium text-gray-600">{division}</p>
                </div>
