  ...
  return (
    <div className="flex gap-7 flex-col">
      <div className="flex justify-between">
        <h2 className="font-medium text-4xl leading-10" style={{ color: '#343434' }}>
          {title}
        </h2>
      ...
      <div className="w-full ">
        <div className="no-scrollbar whitespace-nowrap overflow-x-auto scroll-smooth p-1" ref={slider}>
          {children}
        </div>
      </div>
    </div>
